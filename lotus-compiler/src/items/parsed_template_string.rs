...
use super::{ParsedTemplateStringFragment, make_string_value_from_literal_unchecked};

#[parsable]
pub struct ParsedTemplateString {
    #[parsable(brackets="``", consume_spaces_after_prefix=false, consume_spaces_between_items=false)]
    pub fragments: Vec<ParsedTemplateStringFragment>
}

impl ParsedTemplateString {
