...
pub trait View<P, R, E, D> {
    ...
    fn hover(&self, client: &mut ClientState<P, R, E, D>, graphics_list: &mut Vec<Graphics>) { }

    fn on_mouse_event(&self, client: &mut ClientState<P, R, E, D>, event: &MouseEvent) -> EventHandling { EventHandling::Propagate }
    fn on_wheel_event(&self, client: &mut ClientState<P, R, E, D>, event: &WheelEvent) -> EventHandling { EventHandling::Propagate }
...
pub struct ViewState<P, R, E, D> {
    pub view: Rc<dyn View<P, R, E, D>>,
...
impl<P, R, E, D> ViewState<P, R, E, D> {
    pub fn new(view: Rc<dyn View<P, R, E, D>>,) -> Self {
        Self {
            view,
            hitbox: None,
            hitbox_z: 0.,
