...
export const COMPILER_BINARY_PATH = path.join(ROOT_DIR_PATH, 'target', 'release', 'lotus-compiler');
export const HTML_SRC_DIR_PATH = path.join(ROOT_DIR_PATH, 'html');
export const JAVASCRIPT_SRC_DIR_PATH = path.join(ROOT_DIR_PATH, 'javascript');
